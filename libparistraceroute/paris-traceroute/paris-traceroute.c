...
static uint16_t dst_port[4]  = {6969,  0,   UINT16_MAX, 0};
static uint16_t src_port[4]  = {3083,  0,   UINT16_MAX, 1};
...
int main(int argc, char ** argv)
{
    ...
    */
    ...
    } else if (strcmp(algorithm_name, "mda") == 0) { // || mda_values[6]) {
