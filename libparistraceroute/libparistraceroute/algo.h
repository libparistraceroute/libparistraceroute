 ...
 * function to send a "specified in options" number of probes to a certain adress with a certain TTL
 ...
 * @param options the options
 * @param perso_opt the options of this particular algorithm
 * @return the probe that has been sent
 */
probe_s* uniq_node_query(char* dest_addr,  short dest_port, short source_port, char TTL, algo_s* options, void* perso_opt);
