...
# Source Information
Source0:paris-traceroute-0.9.tar.bz2
#Source2:AUTHORS
#Patch0:
...
%prep
%setup -q -n paris-traceroute-0.9
%build
%configure
...
%files
%defattr(-,root,root,-)
%{_libdir}/libparistraceroute-0.9.so.1.0.0
%{_libdir}/libparistraceroute-0.9.a
%exclude
%{_libdir}/libparistraceroute-0.9.la
%{_libdir}/libparistraceroute-0.9.so
%{_libdir}/libparistraceroute-0.9.so.1
%doc
%changelog
* Mon Oct 27 2014 Jordan Augé <jordan.auge@free.fr> 0.9
- Release of v0.9
